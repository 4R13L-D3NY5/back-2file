...
6. **Verificar el banner de staleness.** Si la respuesta de codegraph comienza con "**Advertencia:** Some files referenced below were edited since the last index sync...", esos archivos estan pendientes de re-indexacion. Leer esos archivos especificos. `codegraph_status` tambien lista archivos pendientes.
